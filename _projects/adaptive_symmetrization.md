...
<div class="project-figure">
  <img src="{{ '/assets/img/symmetric_kl/teaser.png' | relative_url }}" alt="Illustration of different training dynamics">
  <p class="caption">
...
<div class="project-figure">
  <img src="{{ '/assets/img/symmetric_kl/results.png' | relative_url }}" alt="Comparison with NF and WGAN">
  <p class="caption">
    Comparison of negative log-likelihood (NLL) with normalizing flows (NF) and Wasserstein GAN (WGAN).
    The left graph (a) shows that on a small dataset, NF will learn the empirical distribution and with time will diverge from the true distribution.
